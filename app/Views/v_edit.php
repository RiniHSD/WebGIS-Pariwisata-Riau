...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if (auth()->loggedIn()) : ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('home/peta') ?>"><i class="fa-regular fa-map"></i> Peta</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container my-4">
        ...
        <div class="card">
            <div class="card-header">
                <h2><i class="fa-solid fa-plus"></i>Edit Data Lokasi Objek</h2>
            </div>
            <div class="card-body">
                <form action="<?= base_url('home/simpan_edit_data/') . $dataobjek['id'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Input nama objek" value="<?= $dataobjek['nama'] ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <input class="form-control" type="text" id="foto" name="fotolama" value="<?= $dataobjek['foto'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="latitude" class="form-label">Latitude</label>
                        <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Input latitude" value="<?= $dataobjek['latitude'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="longitude" class="form-label">Longitude</label>
                        <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Input longitude" value="<?= $dataobjek['longitude'] ?>">
                    </div>
                    <div class="mb-3">
    ...
    <script>
        ...
        let map = L.map('map').setView(center, 17); //lat, long, zoom
