...
<body>
    ...
    <script>
        /* Initial Map */
        var map = L.map("map").setView([-7.033970048482651, 113.39454926879603], 10);
        /* Tile Basemap */
            ...
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    mouseover: function(e) {
                        ...
                        document.getElementById("id_feature").innerHTML = idPolygon;
        ...
        map.on(L.Draw.Event.EDITED, function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                if (layer instanceof L.Polygon) {
                    var idPolygon = document.getElementById("id_feature").innerHTML;
                    var htmlIdPolygon = '<input type="hidden" id="id_polygon" name="id_polygon" value="' + idPolygon + '">';
                    $('#id_polygon').html(htmlIdPolygon);

                    var namaFeature = document.getElementById("name_feature").innerHTML;
                    $('#edit_polygon_name').val(namaFeature);
        ...
        map.on(L.Draw.Event.DELETED, function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                var confirm = window.confirm("Apakah anda yakin ingin menghapus area: " + nama + "?");
                if (confirm) {
                    // redirect to delete  
